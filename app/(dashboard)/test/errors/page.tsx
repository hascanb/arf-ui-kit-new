    ...
    switch (type) {
      ...
      case 'axios-401':
        error = {
          response: {
            status: 401,
            data: { code: 'UNAUTHORIZED', message: 'Oturum suresi doldu' },
          },
        }
        break
      case 'axios-500':
      ...
      case 'fetch-403':
        error = {
          ...
          message: 'Erisim engellendi',
        }
        break
      case 'custom-low':
        error = {
          code: 'VALIDATION_ERROR',
          message: 'Form dogrulama hatasi',
        }
        break
      default:
    ...
    <div className="container py-8 space-y-8 px-4 sm:px-6 lg:px-8">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Merkezi hata yonetimi, toast feedback merkezi ve global recovery boundary
        </p>
      </div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="rounded-lg border bg-muted/50 p-4">
            <ErrorRenderer
              ...
              message="Bu bir test hatasidir"
              onBack={() => feedback.info('Geri aksiyonu tetiklendi')}
              onRetry={() => feedback.success('Tekrar dene calisti')}
            />
          </div>
        </CardContent>
      </Card>
  ...
  return (
    <ErrorsKitProvider
      ...
      handlerConfig={{
        ...
        on401: () => {
          feedback.warning('Oturum suresi doldu')
        },
      }}
    >
      <TestContent />
