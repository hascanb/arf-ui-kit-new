          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-44">
              <DropdownMenuItem asChild>
                <Link href={`/arf/cargo/settings/system/bank-accounts/${row.original.id}`}>
              ...
              <DropdownMenuItem onSelect={() => void navigator.clipboard?.writeText(`${window.location.origin}/arf/cargo/settings/system/bank-accounts/${row.original.id}`)}>
