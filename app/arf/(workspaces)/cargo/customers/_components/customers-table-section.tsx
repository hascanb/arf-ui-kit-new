    ...
    () => [
      {
        ...
        cell: ({ row }) => (
          <div>
            <Link
              href={`/arf/cargo/customers/${row.original.id}`}
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-52">
                ...
                <DropdownMenuItem asChild>
                  <Link href={`/arf/cargo/customers/${row.original.id}`}>
                    <Eye className="mr-2 size-4" />
                    Detay Görüntüle
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href={`/arf/cargo/customers/${row.original.id}?tab=shipments`}>
                    <PackageSearch className="mr-2 size-4" />
                    Kargo Geçmişi
                  </Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href={`/arf/cargo/customers/${row.original.id}?tab=finance`}>
