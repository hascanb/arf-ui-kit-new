...
export default function ParcaDetayPage() {
	...
	const handleOpenPieceDeliveryModal = useCallback(() => {
		setActionNotice("")
		setDeliveryEntryFirstName("")
		setDeliveryEntryLastName("")
	...
	}, [detail.parca_no, detail.takip_no, loading.pieceReport, pieceReportDescription, pieceReportReason, submitPieceReport])
