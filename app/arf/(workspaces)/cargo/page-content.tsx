...
export default function HomePage() {
  ...
  const recentCargos = [
    { id: "ARF-10000300", customer: "Ahmet Yılmaz", destination: "Ankara", status: "dagitimda", time: "2 saat önce" },
    { id: "ARF-10000301", customer: "Fatma Kaya", destination: "Bursa", status: "teslim_edildi", time: "3 saat önce" },
    { id: "ARF-10000302", customer: "Zeynep Öztürk", destination: "Antalya", status: "beklemede", time: "5 saat önce" },
    { id: "ARF-10000303", customer: "Can Yıldırım", destination: "İzmir", status: "transfer", time: "6 saat önce" },
  ]
                ...
                {recentCargos.map((cargo) => (
                  <div key={cargo.id} className="flex items-center justify-between px-6 py-4 transition-colors hover:bg-muted/50">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <Link href={`/arf/cargo/shipments/${cargo.id}`} className="font-medium hover:underline">
                          {cargo.id}
                        </Link>
                        <p className="text-sm text-muted-foreground">
