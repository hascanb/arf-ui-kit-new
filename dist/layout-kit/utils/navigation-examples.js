 ...
 */
import { Home, Package, Users, Building2, BarChart3, Wallet, Settings, TestTube2, ShieldCheck, LayoutDashboard, FileText, Bell, Palette, } from 'lucide-react';
/**
 * Örnek Marka/Logo Verisi
 */
export const exampleBrandData = {
    title: 'ARF UI Kit',
 ...
 */
export const ecommerceNavGroups = [
    {
        label: 'Menü',
        items: [
            {
